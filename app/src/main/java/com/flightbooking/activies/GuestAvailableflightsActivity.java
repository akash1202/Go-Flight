...
import com.flightbooking.adapters.GuestAvailableFlightsAdapter;
...
public class GuestAvailableflightsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guest_availableflights);
    ...
    public void getRouteInfo(){
        progressDialog = new ProgressDialog(GuestAvailableflightsActivity.this);
        ...
        call.enqueue(new Callback<List<AvailableFlightsPojo>>() {
            ...
            public void onResponse(Call<List<AvailableFlightsPojo>> call, Response<List<AvailableFlightsPojo>> response) {
                ...
                if(response.body()==null){
                    ...
                    list_view.setAdapter(new GuestAvailableFlightsAdapter(availableFlightsPojo,adult,children,classtype, GuestAvailableflightsActivity.this));
            ...
            public void onFailure(Call<List<AvailableFlightsPojo>> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(GuestAvailableflightsActivity.this, "Something went wrong...Please try later!", Toast.LENGTH_SHORT).show();
            }
        });
    }
